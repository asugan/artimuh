...
@section('content')
            ...
            <div class="item bg-img" data-overlay-dark="5" data-background="{{ asset('img/bg_11_11zon.webp') }}">
                <div class="v-middle caption mt-30">
                    <div class="container">
                        ...
                        <a href="#calismalar" class="butn butn-bg mt-30">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="item">
                        ...
                        <div class="cont">
                            <span class="icon"><i class="icofont-gear-alt"></i></span>
    ...
    <section class="blog section-padding" data-scroll-index="2">
        <div class="container">
            <div class="row">
                <div id="calismalar" class="section-head text-center col-lg-8 offset-lg-2 col-md-10 offset-md-1">
